...
# ===== КЛАВИАТУРЫ ДЛЯ АУКЦИОНА =====
def auction_list_keyboard(auctions, page=1, total_pages=1):
    """Формирует инлайн-клавиатуру для списка аукционов."""
    kb = []
...
def auction_detail_keyboard(auction_id):
    """Клавиатура для детального просмотра аукциона."""
    return InlineKeyboardMarkup(inline_keyboard=[
